...
impl DeviceStatus {
    pub fn from_bytes(bytes: &[u8]) -> Self {
        let byte_0_flags = device_status::Byte0Flags::from_bits_truncate(bytes[0]);
        let byte_1_flags = device_status::Byte1Flags::from_bits_truncate(bytes[1]);
        let byte_4_flags = device_status::Byte4Flags::from_bits_truncate(bytes[4]);
        let byte_7_flags = device_status::Byte7Flags::from_bits_truncate(bytes[7]);
        let byte_15_flags = device_status::Byte15Flags::from_bits_truncate(bytes[15]);

        let status_of_safety_function =
            byte_0_flags.contains(device_status::Byte0Flags::STATUS_OF_SAFETY_FUNCTION);
        let status_sleep_mode = byte_0_flags.contains(device_status::Byte0Flags::STATUS_SLEEP_MODE);
        let contamination_warning =
            byte_0_flags.contains(device_status::Byte0Flags::CONTAMINATION_WARNING);
        let contamination_error =
            byte_0_flags.contains(device_status::Byte0Flags::CONTAMINATION_ERROR);
        let reference_contour_monitoring =
            byte_0_flags.contains(device_status::Byte0Flags::REFERENCE_CONTOUR_MONITORING);
        let manipulation = byte_0_flags.contains(device_status::Byte0Flags::MANIPULATION);

        let non_safe_cut_off_path = [
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_01),
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_02),
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_03),
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_04),
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_05),
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_06),
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_07),
            byte_1_flags.contains(device_status::Byte1Flags::NON_SAFE_CUT_OFF_PATH_08),
        ];

        let safety_cut_off_path = [
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_01),
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_02),
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_03),
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_04),
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_05),
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_06),
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_07),
            byte_4_flags.contains(device_status::Byte4Flags::SAFETY_CUT_OFF_PATH_08),
        ];

        let reset_required_cut_off_path = [
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_01),
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_02),
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_03),
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_04),
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_05),
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_06),
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_07),
            byte_7_flags.contains(device_status::Byte7Flags::RESET_REQUIRED_CUT_OFF_PATH_08),
        ];

        let current_monitoring_case_table_1 = bytes[10];
        let current_monitoring_case_table_2 = bytes[11];

        let device_error = byte_15_flags.contains(device_status::Byte15Flags::DEVICE_ERROR);
        let application_error =
            byte_15_flags.contains(device_status::Byte15Flags::APPLICATION_ERROR);
...
mod device_status_block_tests {
    ...
    use crate::data_output::DeviceStatus;
